...
class Application:
    ...
    def __init__(self):
        ...
        self.root = tk.Tk()
        self.root.title("SignoSpeak: Bridging the Gap")
    ...
    def video_loop(self):
        ...
        if ok:
            ...
            self.panel3.config(text = self.current_symbol, font = ("Bebas Neue", 30))
            
            ret, predicts = self.vs.read()
            
            if(len(predicts) > 1):

                self.bt1.config(text = predicts[0], font = ("Bebas Neue", 20))
            ...
            if(len(predicts) > 2):
                ...
                self.bt2.config(text = predicts[1], font = ("Bebas Neue", 20))
            ...
            if(len(predicts) > 3):
                ...
                self.bt3.config(text = predicts[2], font = ("Bebas Neue", 20))
